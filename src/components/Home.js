...
export default function Home() {
    return(
        <div className="h-full w-full  about pt-[10vh] font-vt323 text-yellow-400 flex flex-col items-center justify-center overflow-hidden text-[2.5vh] lg:text-[4vh]">
            ...
            <div>
            <p className="font-extrabold text-[3vh] lg:text-[5vh] p-4 text-cyan-300">What is a deepfake ?</p>
            <p className="px-16 ">A deepfake is a type of synthetic media created using artificial intelligence, specifically deep learning algorithms, to manipulate or generate audio, video, or images. Deepfakes often alter a person's appearance, voice, or actions, making it seem as though they are doing or saying something they never actually did. The technology relies on techniques like GANs (Generative Adversarial Networks) to create highly realistic yet fabricated content. While deepfakes can have creative or humorous uses, they also pose significant ethical concerns, particularly in misinformation, privacy violations, and potential misuse for political or malicious purposes.</p>
        </div>
        <div>
            <p className="font-extrabold text-[3vh] lg:text-[5vh] p-4 text-cyan-300">Harmful effects of Deepfake</p>
            <div className="px-16">
